...
public:
	...
	void changeColor(String eyeColor){
		on=true;
		if(eyeColor.equals("RED")) col.r=255,digitalWrite(rPin,HIGH);
		else if(eyeColor.equals("GREEN")) col.g=255,digitalWrite(gPin,HIGH);
		else if(eyeColor.equals("BLUE")) col.b=255,digitalWrite(bPin,HIGH);
		else on=col.r=col.g=col.b=0,digitalWrite(rPin,LOW),digitalWrite(bPin,LOW),digitalWrite(gPin,LOW);
